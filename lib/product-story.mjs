...
const productIdentityPrompt = [
  'Product-only commercial packshot. The frame must contain only the source product, studio light, and clean background.',
  ...
  'No people, no hands, no fingers, no arms, no body parts, no tools, no pens, no sticks, no utensils, no unrelated boxes, no extra packaging, no lifestyle props, no background clutter.',
