...
export function buildAmdWorkerCloudInit({
  ...
  const environment = encodeEnvironment({
    ...
    WAN_FPS: '16',
    WAN_NUM_FRAMES: '49',
    WAN_INFERENCE_STEPS: '24',
    WAN_GUIDANCE_SCALE: '3.2',
    WAN_IDENTITY_RETRY_GUIDANCE_SCALE: '2.8',
...
export function createDigitalOceanGpuOrchestrator({
  ...
  return { startLease, inspectLease, createLease, releaseLease, reapExpiredLeases, listLeases, listPersistentLeases, checkCapacity, leaseTtlSeconds }
}
