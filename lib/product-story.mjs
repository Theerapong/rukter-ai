...
const motionCatalog = ['push-in', 'pan-left', 'parallax-rise', 'pan-right', 'hero-hold']
...
export function buildProductStoryPlan({ kit = {}, request = {} } = {}) {
  ...
  const shots = Array.from({ length: totalShots }, (_, index) => {
    ...
    return {
      ...
      cinematicPrompt: `Premium commercial product film. ${cinematicCameraCatalog[index]}. Keep the exact product identity, silhouette, proportions, colors, logo, packaging text, hardware, and materials from the reference image. Natural physical motion, cinematic lighting, realistic lens behavior, coherent temporal detail, no on-screen text.`,
