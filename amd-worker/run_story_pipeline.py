...
HUMAN_CONTAMINATION_SOURCE_DELTA = float(os.getenv("WAN_HUMAN_CONTAMINATION_SOURCE_DELTA", "0.015"))
COLOR_DISTRIBUTION_THRESHOLD = float(os.getenv("WAN_COLOR_DISTRIBUTION_THRESHOLD", "0.48"))
